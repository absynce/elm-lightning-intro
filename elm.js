...
var _xarvh$elm_slides$Slides_FragmentAnimation$fade = function (completion) {
	var blur = function (completion) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'blur(',
			A2(
				...
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Basics$round((1 - completion) * 20)),
				'px)'));
	};
	return _rtfeldman$elm_css$Css$asPairs(
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$opacity(
				_rtfeldman$elm_css$Css$num(completion)),
			_1: {
				ctor: '::',
				_0: A2(
					_rtfeldman$elm_css$Css$property,
...
var _xarvh$elm_slides$Slides_SlideAnimation$verticalDeck = function (status) {
	var blur = function (completion) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'blur(',
						...
						_1: {
							...
							_0: _rtfeldman$elm_css$Css$transform(
								A2(
									...
									_rtfeldman$elm_css$Css$pct(_p2 * 100))),
							_1: {
								ctor: '::',
								_0: A2(_rtfeldman$elm_css$Css$property, 'z-index', '2'),
								_1: {ctor: '[]'}
							}
						}
					};
...
var _xarvh$elm_slides$Slides_SlideAnimation$fade = function (status) {
	...
	return _rtfeldman$elm_css$Css$asPairs(
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$opacity(
				_rtfeldman$elm_css$Css$num(opacity)),
			_1: {ctor: '[]'}
		});
};
var _xarvh$elm_slides$Slides_SlideAnimation$scroll = function (status) {
	var position = function () {
		...
		if (_p6.ctor === 'Still') {
			...
			var offset = function () {
				var _p7 = _p6._1;
				if (_p7.ctor === 'EarlierSlide') {
					return 0;
				} else {
					return 100;
				}
			}();
			return offset - (_p6._2 * 100);
		}
	}();
	return _rtfeldman$elm_css$Css$asPairs(
		{
				...
				_1: {
					...
					_0: _rtfeldman$elm_css$Css$transform(
						_rtfeldman$elm_css$Css$translate(
							_rtfeldman$elm_css$Css$pct(position))),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _xarvh$elm_slides$Slides_SlideAnimation$Outgoing = {ctor: 'Outgoing'};
var _xarvh$elm_slides$Slides_SlideAnimation$Incoming = {ctor: 'Incoming'};
var _xarvh$elm_slides$Slides_SlideAnimation$LaterSlide = {ctor: 'LaterSlide'};
var _xarvh$elm_slides$Slides_SlideAnimation$EarlierSlide = {ctor: 'EarlierSlide'};
var _xarvh$elm_slides$Slides_SlideAnimation$Moving = F3(
	function (a, b, c) {
		return {ctor: 'Moving', _0: a, _1: b, _2: c};
	});
var _xarvh$elm_slides$Slides_SlideAnimation$Still = {ctor: 'Still'};

var _xarvh$elm_slides$Slides_Styles$elmMinimalist = F4(
	function (backgroundColorArg, codeBackgroundColorArg, fontSizeArg, colorArg) {
		return {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css_Elements$body(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$backgroundColor(backgroundColorArg),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$color(colorArg),
									_1: {
										ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$fontSize(fontSizeArg),
											_1: {
												ctor: '::',
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css_Elements$section(
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$height(
								_rtfeldman$elm_css$Css$pct(100)),
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css_Elements$code(
								{
									ctor: '::',
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$backgroundColor(codeBackgroundColorArg),
											_1: {ctor: '[]'}
										}
									}
								}),
...
var _xarvh$elm_slides$Slides_Styles$elmBlueOnWhite = A4(
	_xarvh$elm_slides$Slides_Styles$elmMinimalist,
	A3(_rtfeldman$elm_css$Css$rgb, 255, 255, 255),
	A3(_rtfeldman$elm_css$Css$rgb, 230, 230, 230),
	_rtfeldman$elm_css$Css$px(30),
	_rtfeldman$elm_css$Css$hex('60B5CC'));
var _xarvh$elm_slides$Slides_Styles$blackOnWhite = A4(
	_xarvh$elm_slides$Slides_Styles$elmMinimalist,
	A3(_rtfeldman$elm_css$Css$rgb, 255, 255, 255),
	A3(_rtfeldman$elm_css$Css$rgb, 230, 230, 230),
	_rtfeldman$elm_css$Css$px(30),
	_rtfeldman$elm_css$Css$hex('60B5CC'));
var _xarvh$elm_slides$Slides_Styles$whiteOnBlack = A4(
	_xarvh$elm_slides$Slides_Styles$elmMinimalist,
	A3(_rtfeldman$elm_css$Css$rgb, 255, 255, 255),
	A3(_rtfeldman$elm_css$Css$rgb, 230, 230, 230),
	_rtfeldman$elm_css$Css$px(30),
	_rtfeldman$elm_css$Css$hex('fafafb'));

var _xarvh$elm_slides$SmoothAnimator$newPosition = F3(
	function (duration, m, deltaTime) {
		var distance = _elm_lang$core$Basics$toFloat(m.targetPosition) - m.currentPosition;
		var absDistance = _elm_lang$core$Basics$abs(distance);
		var _p0 = (_elm_lang$core$Native_Utils.cmp(distance, 0) > 0) ? {ctor: '_Tuple2', _0: 1, _1: _elm_lang$core$Basics$min} : {ctor: '_Tuple2', _0: -1, _1: _elm_lang$core$Basics$max};
		var direction = _p0._0;
		var limitBetween = _p0._1;
		var totalDistance = _elm_lang$core$Basics$abs(m.initialPosition - m.targetPosition);
		var velocity = _elm_lang$core$Basics$toFloat(
			A2(_elm_lang$core$Basics$max, 1, totalDistance)) / duration;
		var deltaPosition = (deltaTime * direction) * velocity;
		var newUnclampedPosition = m.currentPosition + deltaPosition;
		return A2(
			limitBetween,
			newUnclampedPosition,
			_elm_lang$core$Basics$toFloat(m.targetPosition));
	});
var _xarvh$elm_slides$SmoothAnimator$update = F4(
	function (duration, maximumPosition, msg, oldModel) {
		var select = function (unclampedTargetPosition) {
			return _elm_lang$core$Native_Utils.update(
				oldModel,
				{
					targetPosition: A3(_elm_lang$core$Basics$clamp, 0, maximumPosition, unclampedTargetPosition)
				});
		};
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'SelectExact':
				return select(_p1._0);
			case 'SelectFirst':
				return select(0);
			case 'SelectLast':
				return select(99999);
			case 'SelectPrev':
				return select(oldModel.targetPosition - 1);
			case 'SelectNext':
				return select(oldModel.targetPosition + 1);
			default:
				var currentPosition = A3(_xarvh$elm_slides$SmoothAnimator$newPosition, duration, oldModel, _p1._0);
				var initialPosition = (!_elm_lang$core$Native_Utils.eq(
					currentPosition,
					_elm_lang$core$Basics$toFloat(oldModel.targetPosition))) ? oldModel.initialPosition : oldModel.targetPosition;
				return _elm_lang$core$Native_Utils.update(
					oldModel,
					{currentPosition: currentPosition, initialPosition: initialPosition});
		}
	});
var _xarvh$elm_slides$SmoothAnimator$Model = F3(
	function (a, b, c) {
		return {initialPosition: a, targetPosition: b, currentPosition: c};
	});
var _xarvh$elm_slides$SmoothAnimator$init = function (position) {
	return A3(
		_xarvh$elm_slides$SmoothAnimator$Model,
		position,
		position,
		_elm_lang$core$Basics$toFloat(position));
};
var _xarvh$elm_slides$SmoothAnimator$AnimationTick = function (a) {
	return {ctor: 'AnimationTick', _0: a};
};
var _xarvh$elm_slides$SmoothAnimator$SelectPrev = {ctor: 'SelectPrev'};
var _xarvh$elm_slides$SmoothAnimator$SelectNext = {ctor: 'SelectNext'};
var _xarvh$elm_slides$SmoothAnimator$SelectLast = {ctor: 'SelectLast'};
var _xarvh$elm_slides$SmoothAnimator$SelectFirst = {ctor: 'SelectFirst'};
var _xarvh$elm_slides$SmoothAnimator$SelectExact = function (a) {
	return {ctor: 'SelectExact', _0: a};
};

var _xarvh$elm_slides$StringUnindent$unindent = function (multilineString) {
	var countLeadingSpaces = function (line) {
		var _p0 = _elm_lang$core$String$uncons(line);
		if (_p0.ctor === 'Nothing') {
			return 0;
		} else {
			var _p1 = _p0._0._0;
			if (_p1.valueOf() === ' ') {
				return 1 + countLeadingSpaces(_p0._0._1);
			} else {
				return 0;
			}
		}
	};
	var lines = _elm_lang$core$String$lines(multilineString);
	var minLead = A2(
		_elm_lang$core$Maybe$withDefault,
		0,
...
var _xarvh$elm_slides$Slides$slideSection = F2(
	function (styleAttributes, fragments) {
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('slide-content'),
						_1: {ctor: '[]'}
					},
					fragments),
				_1: {ctor: '[]'}
...
var _xarvh$elm_slides$Slides$noCmd = function (m) {
	return {ctor: '_Tuple2', _0: m, _1: _elm_lang$core$Platform_Cmd$none};
};
var _xarvh$elm_slides$Slides$fragmentAnimatorUpdate = F4(
	function (maximumPosition, options, oldParentModel, msg) {
		var newChildModel = A4(_xarvh$elm_slides$SmoothAnimator$update, options.animationDuration, maximumPosition, msg, oldParentModel.fragmentAnimation);
		var newParentModel = _elm_lang$core$Native_Utils.update(
			oldParentModel,
			{fragmentAnimation: newChildModel});
		return _xarvh$elm_slides$Slides$noCmd(newParentModel);
	});
var _xarvh$elm_slides$Slides$slideDistance = function (model) {
	return _elm_lang$core$Basics$toFloat(model.slideAnimation.targetPosition) - model.slideAnimation.currentPosition;
};
var _xarvh$elm_slides$Slides$modelToHashUrl = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#',
		_elm_lang$core$Basics$toString(model.slideAnimation.targetPosition));
};
var _xarvh$elm_slides$Slides$slideAnimatorUpdate = F3(
	function (options, oldParentModel, childMsg) {
		var currentIndexInUrl = function () {
			var _p0 = childMsg;
			if (_p0.ctor === 'SelectExact') {
				return _p0._0;
			} else {
				return oldParentModel.slideAnimation.targetPosition;
			}
		}();
		var maximumPosition = _elm_lang$core$Array$length(oldParentModel.slides) - 1;
		var duration = options.animationDuration;
		var newChildModel = A4(_xarvh$elm_slides$SmoothAnimator$update, duration, maximumPosition, childMsg, oldParentModel.slideAnimation);
		var newParentModel = _elm_lang$core$Native_Utils.update(
			oldParentModel,
			{slideAnimation: newChildModel});
		var cmd = _elm_lang$core$Native_Utils.eq(newChildModel.targetPosition, currentIndexInUrl) ? _elm_lang$core$Platform_Cmd$none : _elm_lang$navigation$Navigation$newUrl(
			_xarvh$elm_slides$Slides$modelToHashUrl(newParentModel));
		return {ctor: '_Tuple2', _0: newParentModel, _1: cmd};
	});
var _xarvh$elm_slides$Slides$locationToSlideIndex = function (location) {
	return _elm_lang$core$Result$toMaybe(
		_elm_lang$core$String$toInt(
			A2(_elm_lang$core$String$dropLeft, 1, location.hash)));
};
var _xarvh$elm_slides$Slides$scale = F2(
	function (options, model) {
		return A2(
			_elm_lang$core$Basics$min,
			_elm_lang$core$Basics$toFloat(model.windowSize.width) / _elm_lang$core$Basics$toFloat(options.slidePixelSize.width),
			_elm_lang$core$Basics$toFloat(model.windowSize.height) / _elm_lang$core$Basics$toFloat(options.slidePixelSize.height));
	});
var _xarvh$elm_slides$Slides$PrivateSlide = function (a) {
	return {fragments: a};
};
var _xarvh$elm_slides$Slides$slideByIndex = F2(
	function (model, index) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_xarvh$elm_slides$Slides$PrivateSlide(
				{ctor: '[]'}),
			A2(_elm_lang$core$Array$get, index, model.slides));
	});
var _xarvh$elm_slides$Slides$resetFragments = F2(
	function (distance, oldModel) {
		var newPosition = (_elm_lang$core$Native_Utils.cmp(distance, 0) > 0) ? 0 : (_elm_lang$core$List$length(
			A2(_xarvh$elm_slides$Slides$slideByIndex, oldModel, oldModel.slideAnimation.targetPosition).fragments) - 1);
		return _elm_lang$core$Native_Utils.update(
			oldModel,
			{
				fragmentAnimation: _xarvh$elm_slides$SmoothAnimator$init(newPosition)
			});
	});
var _xarvh$elm_slides$Slides$fragmentsByPosition = F4(
	function (options, model, index, fragmentPosition) {
		var completionByIndex = function (index) {
			return A3(
				_elm_lang$core$Basics$clamp,
				0,
				1,
				(1 + fragmentPosition) - _elm_lang$core$Basics$toFloat(index));
		};
		var styleFrag = F2(
			function (index, frag) {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fragment-content'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
		...
		var slide = A2(_xarvh$elm_slides$Slides$slideByIndex, model, index);
		var styledFragments = A2(_elm_lang$core$List$indexedMap, styleFrag, slide.fragments);
		return styledFragments;
	});
var _xarvh$elm_slides$Slides$slideViewMotion = F2(
	function (options, model) {
		var fragByPos = A2(_xarvh$elm_slides$Slides$fragmentsByPosition, options, model);
		var slideAnimator = options.slideAnimator;
		var distance = _xarvh$elm_slides$Slides$slideDistance(model);
		var easing = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$abs(distance),
			1) > 0) ? _elm_lang$core$Basics$identity : ((_elm_lang$core$Native_Utils.cmp(distance, 0) > -1) ? options.easingFunction : _elm_community$easing_functions$Ease$flip(options.easingFunction));
		var smallerIndex = _elm_lang$core$Basics$floor(
			model.slideAnimation.currentPosition - ((_elm_lang$core$Native_Utils.cmp(distance, 0) > 0) ? 0 : 1.0e-6));
		var largerIndex = smallerIndex + 1;
		var completion = easing(
			model.slideAnimation.currentPosition - _elm_lang$core$Basics$toFloat(smallerIndex));
		var _p1 = (_elm_lang$core$Native_Utils.cmp(distance, 0) > 0) ? {ctor: '_Tuple2', _0: _xarvh$elm_slides$Slides_SlideAnimation$Outgoing, _1: _xarvh$elm_slides$Slides_SlideAnimation$Incoming} : {ctor: '_Tuple2', _0: _xarvh$elm_slides$Slides_SlideAnimation$Incoming, _1: _xarvh$elm_slides$Slides_SlideAnimation$Outgoing};
		var smallerDirection = _p1._0;
		var largerDirection = _p1._1;
		return {
			ctor: '::',
			_0: A2(
				_xarvh$elm_slides$Slides$slideSection,
				slideAnimator(
					A3(_xarvh$elm_slides$Slides_SlideAnimation$Moving, smallerDirection, _xarvh$elm_slides$Slides_SlideAnimation$EarlierSlide, completion)),
				A2(fragByPos, smallerIndex, 9999)),
			_1: {
				ctor: '::',
				_0: A2(
					_xarvh$elm_slides$Slides$slideSection,
					slideAnimator(
						A3(_xarvh$elm_slides$Slides_SlideAnimation$Moving, largerDirection, _xarvh$elm_slides$Slides_SlideAnimation$LaterSlide, completion)),
					A2(fragByPos, largerIndex, 0)),
				_1: {ctor: '[]'}
			}
		};
	});
var _xarvh$elm_slides$Slides$slideViewStill = F2(
	function (options, model) {
		return {
			ctor: '::',
			_0: A2(
				_xarvh$elm_slides$Slides$slideSection,
				options.slideAnimator(_xarvh$elm_slides$Slides_SlideAnimation$Still),
				A4(_xarvh$elm_slides$Slides$fragmentsByPosition, options, model, model.slideAnimation.targetPosition, model.fragmentAnimation.currentPosition)),
			_1: {ctor: '[]'}
		};
	});
var _xarvh$elm_slides$Slides$view = F2(
		...
		var css = function (_) {
			...
			_rtfeldman$elm_css$Css$compile(
				A3(
					...
					{ctor: '[]'},
					_rtfeldman$elm_css$Css$stylesheet(options.style))));
		var slideView = _elm_lang$core$Native_Utils.eq(
			_xarvh$elm_slides$Slides$slideDistance(_p5),
			0) ? _xarvh$elm_slides$Slides$slideViewStill : _xarvh$elm_slides$Slides$slideViewMotion;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
								...
								}(
									{
										...
										_0: _rtfeldman$elm_css$Css$width(
											_rtfeldman$elm_css$Css$px(
												_elm_lang$core$Basics$toFloat(options.slidePixelSize.width))),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$height(
												_rtfeldman$elm_css$Css$px(
													_elm_lang$core$Basics$toFloat(options.slidePixelSize.height))),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$transforms(
													{
														...
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$scale(
																A2(_xarvh$elm_slides$Slides$scale, options, _p5)),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$bottom(_rtfeldman$elm_css$Css$auto),
															_1: {
																ctor: '::',
																_0: _rtfeldman$elm_css$Css$right(_rtfeldman$elm_css$Css$auto),
																_1: {
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$absolute),
																	_1: {
						...
						A2(slideView, options, _p5)),
					_1: {ctor: '[]'}
				}
			});
	});
var _xarvh$elm_slides$Slides$PrivateModel = F5(
	function (a, b, c, d, e) {
		return {slides: a, windowSize: b, isPaused: c, slideAnimation: d, fragmentAnimation: e};
	});
var _xarvh$elm_slides$Slides$Options = F7(
	function (a, b, c, d, e, f, g) {
		return {style: a, slideAnimator: b, fragmentAnimator: c, easingFunction: d, animationDuration: e, slidePixelSize: f, keyCodesToMsg: g};
	});
var _xarvh$elm_slides$Slides$Slide = function (a) {
	return {ctor: 'Slide', _0: a};
};
var _xarvh$elm_slides$Slides$htmlFragments = function (htmlNodes) {
	return _xarvh$elm_slides$Slides$Slide(
		{fragments: htmlNodes});
};
var _xarvh$elm_slides$Slides$html = function (htmlNode) {
	return _xarvh$elm_slides$Slides$htmlFragments(
		{
			ctor: '::',
			_0: htmlNode,
			_1: {ctor: '[]'}
...
var _xarvh$elm_slides$Slides$mdFragments = function (markdownFragments) {
	var markdownDefaultOptions = _evancz$elm_markdown$Markdown$defaultOptions;
	...
	var htmlNodes = A2(
		...
		function (_p6) {
			return A3(
				...
				options,
				{ctor: '[]'},
				_xarvh$elm_slides$StringUnindent$unindent(_p6));
		},
		markdownFragments);
	return _xarvh$elm_slides$Slides$htmlFragments(htmlNodes);
};
var _xarvh$elm_slides$Slides$md = function (markdownContent) {
	return _xarvh$elm_slides$Slides$mdFragments(
		{
			ctor: '::',
			_0: markdownContent,
			_1: {ctor: '[]'}
...
var _xarvh$elm_slides$Slides$NewLocation = function (a) {
	return {ctor: 'NewLocation', _0: a};
};
var _xarvh$elm_slides$Slides$WindowResizes = function (a) {
	return {ctor: 'WindowResizes', _0: a};
};
var _xarvh$elm_slides$Slides$AnimationTick = function (a) {
	return {ctor: 'AnimationTick', _0: a};
};
var _xarvh$elm_slides$Slides$PauseAnimation = {ctor: 'PauseAnimation'};
var _xarvh$elm_slides$Slides$Prev = {ctor: 'Prev'};
var _xarvh$elm_slides$Slides$Next = {ctor: 'Next'};
var _xarvh$elm_slides$Slides$mouseClickDispatcher = F3(
	function (options, model, position) {
		var window = function (component) {
			return _elm_lang$core$Basics$toFloat(
				component(model.windowSize));
		};
		var hh = window(
			function (_) {
				return _.height;
		...
		var s = A2(_xarvh$elm_slides$Slides$scale, options, model);
		var slide = function (component) {
			return s * _elm_lang$core$Basics$toFloat(
				component(options.slidePixelSize));
		};
		var h = slide(
			function (_) {
				return _.height;
		...
		var y = function (x) {
			return ((((0 - x) / w) + ((ww - w) / (2 * w))) + ((hh + h) / (2 * h))) * h;
		};
		var isAbove = _elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$toFloat(position.y),
			y(
				_elm_lang$core$Basics$toFloat(position.x))) < 0;
		return isAbove ? _xarvh$elm_slides$Slides$Prev : _xarvh$elm_slides$Slides$Next;
	});
var _xarvh$elm_slides$Slides$Last = {ctor: 'Last'};
var _xarvh$elm_slides$Slides$First = {ctor: 'First'};
var _xarvh$elm_slides$Slides$slidesDefaultOptions = {
	style: _xarvh$elm_slides$Slides_Styles$elmBlueOnWhite,
	slideAnimator: _xarvh$elm_slides$Slides_SlideAnimation$verticalDeck,
	fragmentAnimator: _xarvh$elm_slides$Slides_FragmentAnimation$fade,
	easingFunction: _elm_community$easing_functions$Ease$inOutCubic,
	animationDuration: 500 * _elm_lang$core$Time$millisecond,
	slidePixelSize: {height: 700, width: 960},
	keyCodesToMsg: {
		ctor: '::',
		_0: {
			msg: _xarvh$elm_slides$Slides$First,
			keyCodes: {
				ctor: '::',
				_0: 36,
				_1: {ctor: '[]'}
		...
		_1: {
			ctor: '::',
			_0: {
				msg: _xarvh$elm_slides$Slides$Last,
				keyCodes: {
					ctor: '::',
					_0: 35,
					_1: {ctor: '[]'}
			...
			_1: {
				ctor: '::',
				_0: {
					msg: _xarvh$elm_slides$Slides$Next,
					keyCodes: {
						ctor: '::',
						_0: 13,
						_1: {
				...
				_1: {
					ctor: '::',
					_0: {
						msg: _xarvh$elm_slides$Slides$Prev,
						keyCodes: {
							ctor: '::',
							_0: 37,
							_1: {
					...
					_1: {
						ctor: '::',
						_0: {
							msg: _xarvh$elm_slides$Slides$PauseAnimation,
							keyCodes: {
								ctor: '::',
								_0: 80,
								_1: {ctor: '[]'}
...
var _xarvh$elm_slides$Slides$Noop = {ctor: 'Noop'};
var _xarvh$elm_slides$Slides$keyPressDispatcher = F2(
	function (keyCodeMap, keyCode) {
		...
		while (true) {
			...
			if (_p7.ctor === '::') {
				var _p8 = _p7._0;
				if (A2(_elm_lang$core$List$member, keyCode, _p8.keyCodes)) {
					return _p8.msg;
				} else {
					var _v3 = _p7._1,
						_v4 = keyCode;
					keyCodeMap = _v3;
					keyCode = _v4;
					continue keyPressDispatcher;
				}
			} else {
				return _xarvh$elm_slides$Slides$Noop;
			}
		}
	});
var _xarvh$elm_slides$Slides$subscriptions = F2(
	function (options, _p9) {
		var _p10 = _p9;
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$ups(
					_xarvh$elm_slides$Slides$keyPressDispatcher(options.keyCodesToMsg)),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$clicks(
						A2(_xarvh$elm_slides$Slides$mouseClickDispatcher, options, _p10._0)),
					_1: {
						ctor: '::',
						_0: _elm_lang$window$Window$resizes(_xarvh$elm_slides$Slides$WindowResizes),
						_1: {
							ctor: '::',
							_0: _elm_lang$animation_frame$AnimationFrame$diffs(_xarvh$elm_slides$Slides$AnimationTick),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _xarvh$elm_slides$Slides$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _xarvh$elm_slides$Slides$update = F3(
	function (options, msg, _p11) {
		var _p12 = _p11;
		var _p16 = _p12._0;
		var isAlreadyChangingSlides = !_elm_lang$core$Native_Utils.eq(
			_xarvh$elm_slides$Slides$slideDistance(_p16),
			0);
		var maximumPosition = _elm_lang$core$List$length(
			A2(_xarvh$elm_slides$Slides$slideByIndex, _p16, _p16.slideAnimation.targetPosition).fragments) - 1;
		var mixedUpdater = F2(
			function (isAboutToChangeSlides, msg) {
				return (isAlreadyChangingSlides || isAboutToChangeSlides) ? A3(_xarvh$elm_slides$Slides$slideAnimatorUpdate, options, _p16, msg) : A4(_xarvh$elm_slides$Slides$fragmentAnimatorUpdate, maximumPosition, options, _p16, msg);
			});
		return A2(
			_elm_lang$core$Tuple$mapFirst,
			_xarvh$elm_slides$Slides$Model,
			function () {
				var _p13 = msg;
				switch (_p13.ctor) {
					case 'Noop':
						return _xarvh$elm_slides$Slides$noCmd(_p16);
					case 'First':
						return A2(mixedUpdater, true, _xarvh$elm_slides$SmoothAnimator$SelectFirst);
					case 'Last':
						return A2(mixedUpdater, true, _xarvh$elm_slides$SmoothAnimator$SelectLast);
					case 'Prev':
						return A2(
							mixedUpdater,
							_elm_lang$core$Native_Utils.cmp(_p16.fragmentAnimation.targetPosition - 1, 0) < 0,
							_xarvh$elm_slides$SmoothAnimator$SelectPrev);
					case 'Next':
						return A2(
							mixedUpdater,
							_elm_lang$core$Native_Utils.cmp(_p16.fragmentAnimation.targetPosition + 1, maximumPosition) > 0,
							_xarvh$elm_slides$SmoothAnimator$SelectNext);
					case 'WindowResizes':
						return _xarvh$elm_slides$Slides$noCmd(
					...
					case 'AnimationTick':
						if (_p16.isPaused) {
							...
							var _p14 = A2(
								mixedUpdater,
								false,
								_xarvh$elm_slides$SmoothAnimator$AnimationTick(_p13._0));
							var m = _p14._0;
							var cmd = _p14._1;
							var distance = _xarvh$elm_slides$Slides$slideDistance(_p16);
							var newModel = ((!_elm_lang$core$Native_Utils.eq(distance, 0)) ? _xarvh$elm_slides$Slides$resetFragments(distance) : _elm_lang$core$Basics$identity)(m);
							return {ctor: '_Tuple2', _0: newModel, _1: cmd};
						}
					default:
						var _p15 = _xarvh$elm_slides$Slides$locationToSlideIndex(_p13._0);
						if (_p15.ctor === 'Nothing') {
							return {
								ctor: '_Tuple2',
								_0: _p16,
								_1: _elm_lang$navigation$Navigation$modifyUrl(
									_xarvh$elm_slides$Slides$modelToHashUrl(_p16))
							};
						} else {
							return A3(
								_xarvh$elm_slides$Slides$slideAnimatorUpdate,
								options,
								_p16,
								_xarvh$elm_slides$SmoothAnimator$SelectExact(_p15._0));
						}
				}
			}());
	});
var _xarvh$elm_slides$Slides$init = F3(
	function (options, wrappedSlides, location) {
		var cmdWindow = A2(_elm_lang$core$Task$perform, _xarvh$elm_slides$Slides$WindowResizes, _elm_lang$window$Window$size);
		var unwrapSlide = function (_p17) {
			var _p18 = _p17;
			return _p18._0;
		};
		var model0 = {
			slides: _elm_lang$core$Array$fromList(
				A2(_elm_lang$core$List$map, unwrapSlide, wrappedSlides)),
			windowSize: options.slidePixelSize,
			isPaused: false,
			slideAnimation: _xarvh$elm_slides$SmoothAnimator$init(0),
			fragmentAnimation: _xarvh$elm_slides$SmoothAnimator$init(0)
		};
		var _p19 = A3(
			_xarvh$elm_slides$Slides$update,
			options,
			_xarvh$elm_slides$Slides$NewLocation(location),
			_xarvh$elm_slides$Slides$Model(model0));
		var model = _p19._0._0;
		var urlCmd = _p19._1;
		var slidePosition0 = model.slideAnimation.targetPosition;
		var slideAnimation = _xarvh$elm_slides$SmoothAnimator$init(slidePosition0);
		return {
			ctor: '_Tuple2',
			_0: _xarvh$elm_slides$Slides$Model(
				_elm_lang$core$Native_Utils.update(
					model,
...
var _xarvh$elm_slides$Slides$app = F2(
	function (options, slides) {
		return A2(
			_elm_lang$navigation$Navigation$program,
			_xarvh$elm_slides$Slides$NewLocation,
			{
				init: A2(_xarvh$elm_slides$Slides$init, options, slides),
				update: _xarvh$elm_slides$Slides$update(options),
				view: _xarvh$elm_slides$Slides$view(options),
				subscriptions: _xarvh$elm_slides$Slides$subscriptions(options)
			});
	});

var _user$project$Main$whatNext = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# What next?',
		_1: {
			ctor: '::',
			_0: '* Try Elm at [elm-lang.org](http://elm-lang.org/try)',
			_1: {
				ctor: '::',
...
var _user$project$Main$howElmReducesJavaScriptFatigue = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# How Elm reduces JavaScript fatigue',
		_1: {
			ctor: '::',
			_0: '* Cohesive ecosystem',
			_1: {
				ctor: '::',
				_0: '* Different language, focused on simplicity',
				_1: {
					ctor: '::',
					_0: '* One framework',
					_1: {
						ctor: '::',
						_0: '* Libraries must follow semantic versioning and provide documentation',
						_1: {
							ctor: '::',
...
var _user$project$Main$elmReducesJavaScriptFatigue = _xarvh$elm_slides$Slides$html(
	A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('elm-reduces-js-fatigue'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Elm reduces JavaScript fatigue'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$alt('JS fatigue vs. Elm'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('images/js-fatigue-vs-elm.jpg'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('image from '),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('https://github.com/dwyl/learn-elm/'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('github.com/dwyl/learn-elm'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$howElmIsReliableExample2Maybe = _xarvh$elm_slides$Slides$htmlFragments(
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$h1,
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('No null or undefined'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$alt('Maybe example'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('maybe-example'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('images/maybe-code.png'),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$Main$howElmIsReliableExample1CompilerError = _xarvh$elm_slides$Slides$html(
	A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('elm-compiler-error'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('The Elm compiler has your back'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$alt('Elm compiler error - name misspelled'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('images/elm-compiler-error.png'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
var _user$project$Main$elmIsReliable = _xarvh$elm_slides$Slides$htmlFragments(
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$h1,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('elm-is-reliable'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Elm is reliable'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('\"No runtime exceptions in practice\"'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$alt('Elm runtime exception tweet'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('runtime-exception-tweet'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src('images/elm-runtime-exception-tweet.gif'),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _user$project$Main$whyElm = _xarvh$elm_slides$Slides$html(
	A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('why-elm'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Why Elm?'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$alt('PLZ not another JS framework'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('images/not-another-js-framework.jpg'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
var _user$project$Main$pollAudience = _xarvh$elm_slides$Slides$html(
	A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('poll-audience'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Poll'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$alt('Show of hands'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('images/poll.jpg'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
								...
								{ctor: '[]'},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('http://www.slate.com/articles/news_and_politics/politics/2016/05/how_to_read_a_poll.html'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('slate.com'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$myHistorySlide = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# My history',
		_1: {
			ctor: '::',
			_0: '* \\> 10 years development experience',
			_1: {
				ctor: '::',
				_0: '* Java -> C# -> JavaScript -> Elm',
				_1: {
					ctor: '::',
					_0: '* JavaScript = My first 💖\n  * Do (allthethings)\n  * Quick feedback loop',
					_1: {
						ctor: '::',
						_0: '* Working alone',
						_1: {
							ctor: '::',
							_0: '* Working on a team',
							_1: {
								ctor: '::',
								_0: '* Healthcare reliability',
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$titleSlide = _xarvh$elm_slides$Slides$html(
	A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('title-slide'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$alt('Elm Logo'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src('images/Elm_logo.png'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Elm Enlightening Eville'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('sub-title'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Reliable Web Development'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('by Jared M. Smith'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _user$project$Main$main = A2(
	_xarvh$elm_slides$Slides$app,
	_elm_lang$core$Native_Utils.update(
		_xarvh$elm_slides$Slides$slidesDefaultOptions,
		{
			style: A2(
				_elm_lang$core$List$append,
				A4(
					...
					A3(_rtfeldman$elm_css$Css$rgb, 230, 230, 230),
					_rtfeldman$elm_css$Css$px(30),
					_rtfeldman$elm_css$Css$hex('323642')),
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css_Elements$img(
						{
	...
	{
		ctor: '::',
		_0: _user$project$Main$titleSlide,
		_1: {
			ctor: '::',
			_0: _user$project$Main$myHistorySlide,
			_1: {
				ctor: '::',
				_0: _user$project$Main$pollAudience,
				_1: {
					ctor: '::',
					_0: _user$project$Main$whyElm,
					_1: {
						ctor: '::',
						_0: _user$project$Main$elmIsReliable,
						_1: {
							ctor: '::',
							_0: _user$project$Main$howElmIsReliableExample1CompilerError,
							_1: {
								ctor: '::',
								_0: _user$project$Main$howElmIsReliableExample2Maybe,
								_1: {
									ctor: '::',
									_0: _user$project$Main$elmReducesJavaScriptFatigue,
									_1: {
										ctor: '::',
										_0: _user$project$Main$howElmReducesJavaScriptFatigue,
										_1: {
											ctor: '::',
											_0: _user$project$Main$whatNext,
											_1: {ctor: '[]'}
										}
									}
								}
